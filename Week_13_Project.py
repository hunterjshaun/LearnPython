...
# he string module will give us access to sting constants.
import string
...
# We can use the '.lower()' function to make all of the users input lowercase. This way we can account for the various ways
